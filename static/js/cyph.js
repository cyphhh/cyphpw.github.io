  ...
  function actualLoad() {
    ...
    container.innerHTML =
        ...
        <ul>
          ...
          <li><a class="fa-solid fa-file" title="Portfolio" onclick="translateContainerDown();"></a></li>
        </ul>
      <div id="portfolio">
        <div id="what">
...
function closePortfolio() {
    ...
    <ul>
      ...
      <li><a class="fa-brands fa-youtube" href="https://www.youtube.com/channel/UCRb1EafkijQzJRPV7J8KDhA" title="Youtube"></a></li>
      <li><a class="fa-brands fa-steam" href="https://steamcommunity.com/id/cy_ph/" title="Steam"></a></li>
      <li><a class="fa-solid fa-file" title="Portfolio" onclick="translateContainerUp(); loadPortfolio()"></a></li>
    </ul>`;
